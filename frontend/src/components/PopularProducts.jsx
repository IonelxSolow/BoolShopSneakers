...
export default function PopularProducts() {
    ...
    //sort by popular
    const popularSneaker = [...sneakers].sort(
        ...
        <>
            <section className="popular-displayer">
                <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <button className="btn btn-main-light" onClick={switchPopularDisplay}>
                        {isPopularGrid ? (
                ...
                {isPopularGrid ? (
                    <div>
                        ...
                        <div className="row g-3">
                            {popularSneaker.slice(popularPage * itemsPerPage, popularPage * itemsPerPage + itemsPerPage).map((sneaker) => (
