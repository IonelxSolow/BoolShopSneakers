...
export default function ProductDisplayer({ currentItems, filteredSneakers, isGrid }) {
        ...
        <>
            <div className="products-displayer  col-8 col-md-10 row">
                {filteredSneakers.result.error ? (
                    ...
                    (
                        isGrid ? (currentItems.map((sneaker) => (
                                    ...
                                    <div className="listcard-content">
                                        ...
                                        <div className="price-section">
                                            {!sneaker.discounted_price ||
                                                ...
                                                <span className="text-dark mb-2">{sneaker.price}&euro;</span>
                                            ) : (
                                                <>
                                                    <span className="original-price">{sneaker.price}&euro;</span>
                                                    <span className="discount-price mb-2">{parseFloat(sneaker.discounted_price).toFixed(2)}$&euro;</span>
                                                </>
                                            )}
