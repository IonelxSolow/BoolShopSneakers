...
export default function LatestProducts() {
    ...
    //sort by latest
    const newestSneaker = [...sneakers].sort(
        ...
        <>
            <section className="newest-displayer mb-5">
                <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <button className="btn btn-main-light" onClick={switchNewestDisplay}>
                        {isNewestGrid ? (
                ...
                {isNewestGrid ? (
                    <div>
                        ...
                        <div className="row g-3">
                            {newestSneaker.slice(newestPage * itemsPerPage, newestPage * itemsPerPage + itemsPerPage).map((sneaker) => (
